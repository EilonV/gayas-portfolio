export const Contact = () => {
    ...
    return <section id='contact' className="contact-wrapper flex">
        <div className="contact flex">
            ...
            <ul className="flex">
                <li><a href="https://www.instagram.com/gaya_shayo/" target='noopener'>
                ...
                <li><a href="https://www.facebook.com/profile.php?id=100007186176433" target='noopener'>
                ...
                <li><a href="https://wa.me/0542886347" target='noopener'>
